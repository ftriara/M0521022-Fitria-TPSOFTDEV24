            ...
            <div class="col-lg-12">
                <div class="p-5">
                    ...
                    <form method="post" action="/books">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="number" class="form-control" id="auth_id" name="auth_id" placeholder="Id Penulis" required value="{{ old('auth_id') }}">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" class="form-control" id="cat_id" name="cat_id" placeholder="Id Kategori" required value="{{ old('cat_id') }}">
                            </div>
                        </div>
                        <div class="text-center">
